...
print("\nConexiones:")
for i in range(len(recorrido_sin_repetir) - 1):
    print(recorrido_sin_repetir[i], "-", recorrido_sin_repetir[i+1], "Costo:", G[recorrido_sin_repetir[i]][recorrido_sin_repetir[i+1]]['costo'])

print()

for i in range(len(recorrido_con_repetir) - 1):
    print(recorrido_con_repetir[i], "-", recorrido_con_repetir[i+1], "Costo:", G[recorrido_con_repetir[i]][recorrido_con_repetir[i+1]]['costo'])
